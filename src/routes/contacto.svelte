        ...
        <div class="w-full lg:flex ">
            ...
            <div class="z-10">
              ...
              <div>
                <div class="flex items-center mb-10">
                  ...
                  <div>
                    <span class="block text-xs font-medium text-black"
                      >Tel.</span
                    >
                    <span class="block font-medium text-black"
                      ><a href="tel:+34678518892">(+34) 678 518 892</a></span
                    >
                  </div>
                </div>
              </div>
              <div class="flex items-center mb-10">
                ...
                <div>
                  ...
                  >
                  <span class="block font-medium text-black"
                    ><a href="mailto:info@agencyga.com">
                      info@agencyga.com</a
                    ></span
                  >
                </div>
              ...
              <div class="flex items-center mb-10">
                ...
                <div>
                  ...
                  <span class="block font-medium text-black"
                    >Avenida Zarautz, 20018 San Sebastian</span
                  >
                </div>
              </div>
            </div>
          ...
          >
            <div class="flex justify-center">
              <div>
                <h2 class="text-2xl mb-5 text-black font-handwriting">
                  Deja una nota
                </h2>
                <span class="mb-5 text-3xl font-bold text-brightPink"
